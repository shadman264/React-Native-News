...
export default class NewsDivs extends Component {
        ...
        constructor(props) {
                ...
                this.state = {
                    ...
                    margin: "3%",
                    paddingVal: 0,
                    noOfComment: this.props.commentsTotal,
                    addComment: false,
                };
        }
        ...
        handleAddComment(comment){
                if(typeof comment != "undefined" && comment.length>0){
                        let x = parseInt(this.state.noOfComment);
                        x++;
                        this.setState({
                                noOfComment: x,
                                text: ""
...
//                s = s.concat("...");
                ...
                let midArticleHeight = ScreenHeight * .73 - topHeadlineHeight;
                                        ...
                                        <Body>
                                                ...
                                                <View style={{flex: 1, flexDirection: "row"}}>
                                                        ...
                                                        <View style={{flex: 1, flexDirection: "row"}}>
                                                                ...
                                                                <Text note> {this.props.attachmentTotal} Attached</Text>
                                                        </View>
                                                </View>
                        ...
                        <Footer style={{height : bottomFooterHeight}}>
                            <FooterTab style={{backgroundColor: this.state.cmtBackgroundColor}}>
                                <View style={{flex: 1, flexDirection: "row", paddingLeft: "6%", paddingTop: '2%'}}>
                                    ...
                                    <Text note>  {this.state.noOfComment} Comments</Text>
                                </View>
                            </FooterTab>
                        </Footer>
                                ...
                                <Modal
                                        ...
                                        <Content style={{ borderRadius: 6, margin: "10%",position: "absolute",width: "80%", marginTop: "33%", marginBottom: "67%", padding: "3%", backgroundColor: "white"}}>
                                            ...
                                            <Button full style={{ borderRadius: 6, backgroundColor: "#5a2fd1"}}
                                                onPress={() => this.setState({ addComment: true, paddingVal:0, modalVisible: false, backgroundColor: "white", cmtBackgroundColor: "#e6e4e2", margin: "3%"})}>
                ...
                //CREATE WEB_SOCKET CALL
                let caller;
                if(this.state.addComment){
                        console.log("TRY TO ADD COMMENT!!!!!");
                        this.state.addComment = false;
                        caller =
                                <WebsocketClient type="comment" clickedId={this.state.clickedId} handleComment={this.handleAddComment.bind(this)} comment={this.state.text}/>
